...
class MessageDialogRepository {

    fun getMessageListApi(returnValue: (MessagesModel) -> Unit) {
        RetrofitClient.instance!!.getMessageList(getAppPref().getString(InterConst.ID)!!, true).enqueue(object : Callback<MessagesModel> {
