...
class NewParentMessageActivity : BaseActivity<NewParentMessageViewModel>(),ParentMsgNameAddedAdapter.ClickInterface, View.OnClickListener {
        ...
        when (view!!.id) {
            ...
            R.id.imgAdd -> {
                ParentMessageSelectNameDialog(mContext, R.style.pullBottomfromTop, R.layout.dialog_message_select_name,
                        mChildrenList,
                        object : ParentMessageSelectNameDialog.IndexClick {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode==CAMERA_REQUEST){
            ...
            imgViewAttach!!.setImageBitmap(thumbnail)
        }
    }
}
