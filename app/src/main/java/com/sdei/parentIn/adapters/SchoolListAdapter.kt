...
class SchoolListAdapter(var con: Context,
                        var mData: ArrayList<SchoolModel.DataBean>,
                        var mClick: InterfacesCall.IndexClick) : RecyclerView.Adapter<SchoolListAdapter.ViewHolder>() {
