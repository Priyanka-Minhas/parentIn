...
class TeacherMessageAddNameAdapter(var context: Context, var mData: ArrayList<ClassModel.DataBean>,
                                   var mClick: InterfacesCall.IndexClick) : RecyclerView.Adapter<TeacherMessageAddNameAdapter.ViewHolder>() {
