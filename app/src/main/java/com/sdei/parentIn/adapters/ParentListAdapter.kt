...
class ParentListAdapter(var con: Context,
                        var mData: ArrayList<TeacherModel.DataBean>,
                        var mClick: InterfacesCall.IndexClick) : RecyclerView.Adapter<ParentListAdapter.ViewHolder>() {
