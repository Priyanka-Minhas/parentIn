...
class ParentMsgNameAddedAdapter(var context: Context, var mData: ArrayList<ChildModel.DataBean>,
                                var mClick: ClickInterface) : RecyclerView.Adapter<ParentMsgNameAddedAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.txtParentName.text = mData[position].teacherFirstName
